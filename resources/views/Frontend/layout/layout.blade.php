...
<head>
	...
	<!-- Favicons
		================================================== -->
	<link rel="shortcut icon" href="{{asset('resources/frontend/assetss/images/house-logo.png')}}">
	<link rel="apple-touch-icon" href="{{asset('resources/frontend/assetss/images/apple-touch-icon.html')}}">
	...
	<!-- CSS
	================================================== -->
	<link rel="stylesheet" href="{{asset('resources/frontend/assetss/css/plugins.css">
    <link rel="stylesheet" href="{{asset('resources/frontend/assetss/css/colors.css">
